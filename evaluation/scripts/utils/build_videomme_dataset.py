...
def main(args):
    video_root = os.path.join(args.hf_root, 'data')
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.hf_qwen25vl7b_path)
    ...
    for idx, row in tqdm(annos.iterrows(), total=len(annos)):
        ...
        d = {
            ...
            "videos": [
                os.path.join(video_root, f'{row["videoID"]}.mp4')
            ],
            "meta": {
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hf_qwen25vl7b_path', type=str, required=True)
