...
def main(args):
    video_root = os.path.join(args.hf_root, 'MLVU/video')
    ...
    for anno_file in anno_files:
        ...
        for sample in raw_data:
            ...
            question_id = sample['video'].split('.')[0] + "_" + str(idx)
            idx += 1
            ...
            d = {
                ...
                "videos": [
                    os.path.join(video_root, os.path.basename(anno_file).split('.')[0], sample["video"])
                ],
                "meta": {
                    "video": sample["video"],
