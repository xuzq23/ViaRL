...
@dataclass
class ReinforcePlusPlusConfig(TrainingArguments):
    r"""
    Configuration class for the [`ReinforcePlusPlusTrainer`].

    Only the parameters specific to ReinforcePlusPlus training are listed here. For details on other parameters, refer to the
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`ReinforcePlusPlusTrainer`] is provided as a string.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in ReinforcePlusPlus we usually rely on
